...
/////////////
    ...
    
    {
      ...
      if($utilisateur['userlogin']===$_POST['userlogin'])
      {
        ...
        $sql = "INSERT INTO utilisateur (userlogin, pwd, prenom, nom, photo, role) VALUES (?,?,?,?,?,?)";
        $pdo->prepare($sql)->execute([$_POST['userlogin'],$_POST['pwd'] , $_POST['prenom'],$_POST['nom'],$_POST['avatar'],"admin" ]);
        echo "successs ";
      }
    }
    ?>